        ...
        <div className='w-full flex items-center justify-center py-4 px-10 md:px-16'>
            <div
                ...
                <div className='w-full flex gap-4 items-center justify-center'>
                    <button className='text-white rounded-lg px-4 md:px-6 py-2 md:py-3 bg-gradient-to-b from-[#474747] via-[#212121] to-[#212121]'>Take a tour</button>
                    <button className='rounded-lg px-4 md:px-6 py-2 md:py-3 bg-gradient-to-b from-primary-color to-primary-color/80 border-primary-color/50 border-[1px] text-white'>Book a date</button>
                </div>
            </div>
        </div>
    )
